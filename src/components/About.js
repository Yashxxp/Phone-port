        ...
        <div className="about-scroll flex-1 overflow-y-auto px-4" style={{ height: 'calc(100% - 60px)' }}>
          ...
          <div className="px-6 pb-4">
            <div className="grid grid-cols-2 gap-3">
              <a href="https://twitter.com/twinshu_parmar" target="_blank" rel="noopener noreferrer" className="bg-blue-100 text-black rounded-xl py-3 font-semibold text-base shadow text-center transition hover:bg-blue-200">Twitter<br /><span className="text-xs font-normal">Yash_Mhatre</span></a>
              <a href="https://linkedin.com/in/twinshu-parmar" target="_blank" rel="noopener noreferrer" className="bg-blue-100 text-black rounded-xl py-3 font-semibold text-base shadow text-center transition hover:bg-blue-200">LinkedIn<br /><span className="text-xs font-normal">yash-mhatre</span></a>
            </div>
            <div className="flex justify-center mt-3">
              <a href="https://github.com/twi05" target="_blank" rel="noopener noreferrer" className="bg-blue-100 text-black rounded-xl py-3 px-8 font-semibold text-base shadow text-center transition hover:bg-blue-200">GitHub<br /><span className="text-xs font-normal">Yashxxp</span></a>
            </div>
          </div>
