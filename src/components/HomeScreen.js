...
const HomeScreen = ({ wallpaper, onAppOpen }) => {
  ...
  const apps = [
    ...
    { id: 'resume', icon: faFileAlt, name: 'Resume', link: 'https://drive.google.com/file/d/1eZljQnfDszWvvZ5n7eDqQOzgyBJ9rIAm/view?usp=drive_link' },
  ...
  const dockApps = [
    ...
    { id: 'resume', icon: faBookOpen, name: 'Resume', link: 'https://drive.google.com/file/d/1eZljQnfDszWvvZ5n7eDqQOzgyBJ9rIAm/view?usp=drive_link' },
    { id: 'about', icon: faUser, name: 'About', link: '/about' }
  ];
