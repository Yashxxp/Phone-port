...
const notes = [
  ...
  {
    title: "Soft Skills",
    content: "<b>Soft Skills</b><br/>Communication, Teamwork, Leadership, Problem Solving, Adaptability"
  },
  {
    title: "Achievements",
    ...
    <div className={`home-bg${exiting ? ' fade-exit' : ''}`} style={{ fontFamily: 'Poppins, Inter, Arial, sans-serif' }}>
      ...
      <div className={`iphone-frame${entering ? ' app-entering' : ''}`} style={{ background: '#fff', minHeight: 600, display: 'flex', flexDirection: 'column', overflow: 'hidden', border: '2px solid #222' }}>
        ...
        <div style={{
          ...
          <div style={{ fontWeight: 700, textDecoration: 'underline', textUnderlineOffset: 3, marginBottom: 4, marginTop: 8 }}>LANGUAGES</div>
          <div style={{ marginBottom: 16 }}>C, C++, Javascript, Java</div>
          <div style={{ fontWeight: 700, textDecoration: 'underline', textUnderlineOffset: 3, marginBottom: 4 }}>FRAMEWORKS/LIBRARIES</div>
          <div style={{ marginBottom: 16 }}>Angular, React.js, Serverless</div>
          <div style={{ fontWeight: 700, textDecoration: 'underline', textUnderlineOffset: 3, marginBottom: 4 }}>TOOLS</div>
          <div style={{ marginBottom: 16 }}>Git, Github, AWS, VSCode, Postman</div>
          <div style={{ fontWeight: 700, textDecoration: 'underline', textUnderlineOffset: 3, marginBottom: 4 }}>DATABASES</div>
          <div style={{ marginBottom: 16 }}>MySQL, MongoDB, DynamoDB</div>
          <div style={{ fontWeight: 700, textDecoration: 'underline', textUnderlineOffset: 3, marginBottom: 4 }}>OTHERS</div>
          <div>Data Structures & Algorithms, OOP, Technical Writing</div>
        </div>
        {/* Bottom Bar */}
        <div style={{
          height: 48,
